...
class Retriever:
    ...
    def load_retriever(self):
        """Build (once) and always return an active retriever."""
        ...
        # 2) Build retrievers once
        if not self.retriever:
            # ---- Base MMR retriever (diversity-aware) ----
            ...
            self.base_retriever = mmr_retriever  # keep a handle to the raw MMR retriever

            print("Retriever loaded successfully.")

            # ---- Compression wrapper (LLMChainFilter) ----
        ...
        # 3) Always return the active (compressed) retriever
...
if __name__=='__main__':
    ...
    # this is not an actual output, this is just to test the pipeline
